function random_hold_out(fichero_de_entrada,num_par_train_test)
...
if file ~= -1
    ...
    for k=1:num_par_train_test
        ...
        fileTest = fopen([fichero_de_entrada '_rho_test' numParExtension int2str(k) '.arff'],'w');
        fileEntrenamiento = fopen([fichero_de_entrada '_rho_train' numParExtension int2str(k) '.arff'], 'w');
