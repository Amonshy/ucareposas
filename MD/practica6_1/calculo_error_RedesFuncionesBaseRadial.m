function error = calculo_error_RedesFuncionesBaseRadial(vecinos,fichero_train, fichero_test)
% error = calculo_error_RedesFuncionesBaseRadial(numMax_vecino, fichero_train, fichero_test,rango)
