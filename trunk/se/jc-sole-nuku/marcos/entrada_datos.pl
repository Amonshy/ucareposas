...
leer_nombre(59):- write(', [es-[val([deporte])],'),get0(C),C\==59,leer_categoria(C),!.
...
leer_nombre(C):- write('marco('),put(C),get0(X),leer_nombre_recur(X).
...
leer_categoria(C):- write('categoria-[val(['),put(C),get0(X),leer_categoria_recur(X).

leer_categoria_recur(44):-write(','),get0(X),leer_categoria_recur(X),!.  %,
...
leer_instalacion(C):- write('instalacion-[val(['),put(C),get0(X),leer_instalacion_recur(X).

leer_instalacion_recur(44):-write(','),get0(X),leer_instalacion_recur(X),!.  %,
...
leer_accesorio(C):- write('accesorio-[val(['),put(C),get0(X),leer_accesorio_recur(X).

leer_accesorio_recur(44):-write(','),get0(X),leer_accesorio_recur(X),!.  %,
...
leer_jugadores(C):- write('jugadores-[val(['),put(C),get0(X),leer_jugadores_recur(X).

leer_jugadores_recur(44):-write(','),get0(X),leer_jugadores_recur(X),!.  %,
...
leer_otros(C):- write('otros-[val(['),put(C),get0(X),leer_otros_recur(X).

leer_otros_recur(44):-write(','),get0(X),leer_otros_recur(X),!.  %,
leer_otros_recur(59):-write('])]'),leer_otros(59),!.                                        %;
leer_otros_recur(C):- put(C),get0(X),leer_otros_recur(X).

%------------------------------------DEPORTES-----------------------------------------------
leer_deportes(59):- !.
leer_deportes(C):- write('nombre-[val(['),put(C),get0(X),leer_deportes_recur(X).

leer_deportes_recur(44):-write(','),get0(X),leer_deportes_recur(X),!.  %,
