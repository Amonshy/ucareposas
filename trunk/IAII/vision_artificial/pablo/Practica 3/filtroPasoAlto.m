...
%filtro paso_alta sobre ese umbral, el umbra debe estar entre 0 y 1
%Devuelve la imagen con el filtro pasado

function y = filtorPasoAlto(I,umb)
...
%al centro es menor que el radio entonces lo ponemos a 0 si no nada.
for i = 1:lado1
    for j = 1:lado2
