function [ errorPromedio k_optima ] = estimar_error_RedesFuncionesBaseRadial (nombre_bd)
% [ errorPromedio k_optima ] = estimar_error_RedesFuncionesBaseRadial (nombre_bd)
