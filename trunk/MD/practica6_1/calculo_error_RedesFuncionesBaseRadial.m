...
% la semilla y los fichero de test y entrenamiento.
    orden = sprintf('!java -classpath ";weka.jar" weka.classifiers.functions.RBFNetwork -B %i -S %i -R 1.0E-8 -M -1 -W 0.1 -t %s -T %s > salida.txt',numFunciones,semilla, fichero_train,fichero_test);
    eval(orden);
